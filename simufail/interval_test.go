...
func TestMergeNodes(t *testing.T) {
	tests := []struct {
		...
		{"1000,2000,1,0.333 4000,6000,1,0.666", "500,4500,1,0.333 5500,10000,1,0.333", "[{500 1000 1 0.333} {1000 2000 1 0.666} {2000 4000 1 0.333} {4000 4500 1 0.999} {4500 5500 1 0.666} {5500 6000 1 0.999} {6000 10000 1 0.333}]"},
	}
...
func TestMergeZones(t *testing.T) {
	tests := []struct {
		...
		{"", "1,10,1,1 30,100,1,1", "[{1 10 1 1} {30 100 1 1}]"},
		{"1,10,1,1 30,100,1,1", "", "[{1 10 1 1} {30 100 1 1}]"},
		{"1,10,1,1 20,30,1,1", "1,50,1,1", "[{1 10 2 1} {10 20 1 1} {20 30 2 1} {30 50 1 1}]"},
		{"10,20,1,1 30,40,1,1", "20,30,1,1 35,45,1,1", "[{10 20 1 1} {20 30 1 1} {30 35 1 1} {35 40 2 1} {40 45 1 1}]"},
		{"20,30,1,1 35,45,1,1", "10,20,1,1 30,40,1,1", "[{10 20 1 1} {20 30 1 1} {30 35 1 1} {35 40 2 1} {40 45 1 1}]"},
		{"30,40,1,1 40,50,1,1", "10,35,1,1 38,45,1,1 48,60,1,1", "[{10 30 1 1} {30 35 2 1} {35 38 1 1} {38 40 2 1} {40 45 2 1} {45 48 1 1} {48 50 2 1} {50 60 1 1}]"},
		{"10,22,1,1", "15,22,1,1 30,40,1,1", "[{10 15 1 1} {15 22 2 1} {30 40 1 1}]"},
		{"10,22,1,1", "15,22,1,1", "[{10 15 1 1} {15 22 2 1}]"},
		{"1000,2000,1,1 4000,6000,1,1", "500,4500,1,1 5500,10000,1,1", "[{500 1000 1 1} {1000 2000 2 1} {2000 4000 1 1} {4000 4500 2 1} {4500 5500 1 1} {5500 6000 2 1} {6000 10000 1 1}]"},
	}
